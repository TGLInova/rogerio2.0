...
<section class="grid grid-cols-2 gap-16">
    <div class="relative flex items-center justify-center">
        <div class="bg-primary-400 rounded-2xl h-5/6 w-full absolute animate-fade animate-duration-1000"></div>
        <img src="{{ $image }}" class="z-10 relative h-[23rem] drop-shadow-[5px_5px_5px_black]">
    </div>
