<x-ui::section variant="primary-600" class="relative overflow-hidden lg:h-[38rem] flex items-center max-lg:pb-0" x-data="{ y: 0 }">
    ...
    <x-ui::container>
        <div class='max-lg:relative grid lg:grid-cols-2 gap-12 max-lg:text-center'>
            <div class="space-y-9 relative">
                ...
                <x-ui::button variant="primary-400">QUERO TRANSFORMAR MINHAS VENDAS</x-ui::button>
            </div>
            <div style="--bg-image: url({{ asset('static/img/rogerio_araujo_5.webp') }})" class="bg-[image:--bg-image] bg-no-repeat lg:bg-[position:80%_center] lg:bg-[length:auto_100%] bg-contain bg-center lg:absolute lg:h-full h-96 w-full left-0 top-0">
            </div>
        </div>
    </x-ui::container>
</x-ui::section>
